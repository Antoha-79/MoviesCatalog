...
var moviesInCatalog: [Movie] = [
    ...
    Movie(nameEng: "Free Guy", nameRus: "Главный герой", genre: [.fiction, .action, .comedy, .melodrama], description: "Банковский клерк обнаруживает, что он персонаж видеоигры. Фантастическая экшен-комедия с Райаном Рейнольдсом", image: UIImage(named: "film-FreeGue-1"), top: true, dateOfPremiere: Date(), serials: false),
